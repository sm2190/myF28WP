...
btn.addEventListener("click", function () {
    ...
    ourRequest.open('GET', 'https://sm2190.github.io/week4/cities1.json');
...
function renderHTML(data) {
    ...
    for (i = 0; i < data.length; i++) {
        htmlString += "<p>" + data[i].name + " is a city in " + data[i].country + "Where you can enjoy indoor places like: ";
